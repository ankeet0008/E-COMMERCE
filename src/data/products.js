// Skanvi Living — Curated Scandinavian Furniture & Living Collection
const PRODUCTS = [
  // SOFAS
  {
    id: 1,
    ...
    weight: '72 kg',
    description: 'Modulares Ecksofa in weichem, strapazierfähigem Strukturstoff. Großzügige Sitztiefe, hochwertige Federkern-Polsterung und dezente Holzfüße für maximalen Komfort im minimalistischen Wohnbereich.',
  ...
  },
  {
    ...
    weight: '58 kg',
    description: 'Elegantes 3-Sitzer Sofa mit geradliniger Silhouette in hellem Greige. Zeitlose Ästhetik trifft auf sanfte Haptik und langlebigen Federkern.',
  ...
  // SESSEL
  {
    ...
    weight: '16 kg',
    description: 'Kuscheliger Bouclé-Sessel mit organisch geschwungener Rückenlehne. Schafft eine warme, behagliche Ecke in jedem Raum.',
  ...
  },
  {
    ...
    weight: '19 kg',
    description: 'Skulpturaler Loungesessel mit Massivholz-Gestell und dick gepolsterter Woll-Bouclé-Sitzfläche.',
  ...
  // STÜHLE
  {
    ...
    weight: '6.5 kg',
    description: 'Meisterhaft verarbeiteter Holzstuhl aus massiver heller Eiche. Klare skandinavische Formensprache mit ergonomisch gerundeter Lehne.',
  ...
  // ESSTISCHE
  {
    ...
    weight: '34 kg',
    description: 'Runder Esstisch aus dunkel gebeizter Esche. Bietet komfortabel Platz für 4 bis 6 Personen und fungiert als harmonisches Herzstück des Essbereichs.',
  ...
  {
    id: 7,
    name: 'Skulpturaler Esstisch Burgundy',
    category: 'Esstische',
    price: 920,
    sku: 'SKV-TB-0402',
    stock: 5,
    ...
    weight: '42 kg',
    description: 'Markanter Säulentisch im warmen Terrakotta-Burgunderton mit monolithischem Standfuß. Ein architektonisches Statement-Möbel.',
  ...
  {
    id: 8,
    name: 'Wollteppich Organic Shape',
    category: 'Teppiche',
    price: 179.90,
    sku: 'SKV-RG-0501',
    stock: 19,
    ...
    weight: '11 kg',
    description: 'Handgewebter Schurwollteppich mit fließenden, organischen Konturen in sanften Naturtönen. Verleiht jedem Boden sofort Wärme und Textur.',
  ...
  {
    id: 9,
    name: 'Wandspiegel Organische Welle',
    category: 'Spiegel',
    price: 149.00,
    sku: 'SKV-MR-0601',
    stock: 22,
    ...
    weight: '5.2 kg',
    description: 'Wandspiegel mit sanft geschwungenem Rand. Reflektiert Tageslicht und öffnet Räume auf poetische Weise.',
  ...
  {
    id: 10,
    name: 'Minimalistischer Schrank Kopenhagen',
    ...
    weight: '48 kg',
    description: 'Matt lackierter Aufbewahrungsschrank in warmem Korall-/Puder-Ton mit minimalistischen Holzgriffen und vielseitiger Fächeraufteilung.',
  ...
  {
    id: 11,
    name: 'Polsterbett Nuvola',
    category: 'Betten',
    price: 1250.00,
    sku: 'SKV-BD-0801',
    stock: 6,
    dimensions: '180 × 200 cm Liegefläche',
    weight: '62 kg',
    description: 'Gepolstertes Bettgestell in feinem Greige-Leinenstoff mit weichem Kopfteil. Schafft eine ruhige Oase für erholsame Nächte.',
  ...
  {
    id: 12,
    name: 'Essgruppe Eiche Massiv & 4 Stühle',
    category: 'Esstisch-Sets',
    price: 1490.00,
    sku: 'SKV-DS-0901',
    stock: 4,
    dimensions: 'Tisch 160 × 90 cm, 4 Stühle',
    weight: '55 kg',
    description: 'Komplettes Esszimmer-Set aus geölter massiver Eiche. Zeitloses Handwerk und reduzierte Linienführung.',
